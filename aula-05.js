(() => {
  ...
  const injectStyles = () => {
    ...
    style.textContent = `
      ...
      .formalization-compare, .python-formalization-grid, .heuristic-example-grid, .heuristic-decision-grid, .heuristic-areas-grid, .romania-summary-grid, .romania-reading-grid, .guided-status-grid { display:grid; gap:14px; }
      ...
      .formalization-card, .formalization-mini-example, .python-formalization-card, .heuristic-explainer-card, .heuristic-frontier-card, .heuristic-python-card, .heuristic-area-card, .algorithm-choice-card, .concept-anchor-card, .romania-summary-card, .romania-reading-grid article { border:1px solid var(--line); border-radius:20px; background:var(--paper); box-shadow:var(--shadow); }
      .formalization-card, .formalization-mini-example, .python-formalization-card, .heuristic-explainer-card, .heuristic-frontier-card, .heuristic-python-card, .heuristic-area-card, .algorithm-choice-card, .concept-anchor-card, .romania-summary-card { padding:1.2rem; }
      .formalization-card h3, .formalization-mini-example h3, .python-formalization-card h3, .heuristic-explainer-card h3, .heuristic-frontier-card h3, .heuristic-python-card h3, .heuristic-area-card h3, .algorithm-choice-card h3, .concept-anchor-card h3 { margin:0 0 .7rem; }
      ...
      .formalization-mini-example p, .concept-anchor-card p, .romania-summary-card > p, .heuristic-explainer-card p, .heuristic-frontier-card p, .heuristic-python-card p, .heuristic-area-card p, .algorithm-choice-card p { margin:0; }
      ...
      .heuristic-card-note, .heuristic-explainer-card .formula-line, .heuristic-frontier-card .formula-line { margin-top:.9rem; padding:.85rem; border:1px solid var(--line); border-radius:14px; background:var(--soft); color:var(--ink); line-height:1.45; }
      .heuristic-card-note { margin-top:auto; font-size:.96rem; }
      .heuristic-card-note strong, .heuristic-explainer-card .formula-line strong, .heuristic-frontier-card .formula-line strong { color:var(--blue); }
      ...
      body.theme-dark .formalization-card, body.theme-dark .formalization-mini-example, body.theme-dark .python-formalization-card, body.theme-dark .heuristic-explainer-card, body.theme-dark .heuristic-frontier-card, body.theme-dark .heuristic-python-card, body.theme-dark .heuristic-area-card, body.theme-dark .algorithm-choice-card, body.theme-dark .concept-anchor-card, body.theme-dark .concept-anchor-grid article, body.theme-dark .romania-summary-card, body.theme-dark .romania-summary-grid article, body.theme-dark .romania-reading-grid article { background:var(--paper); border-color:var(--line); }
      body.theme-dark .formalization-list li, body.theme-dark .formalization-table th, body.theme-dark .heuristic-frontier-table th, body.theme-dark .heuristic-card-note, body.theme-dark .heuristic-explainer-card .formula-line, body.theme-dark .heuristic-frontier-card .formula-line, body.theme-dark .algorithm-choice-card .choice-rule, body.theme-dark .algorithm-choice-card li { background:var(--soft); }
      ...
      <section class="section section-soft formalization-section" id="formalizacao-informada">
        <div class="container">
          ...
          <div class="python-formalization-grid">
            <article class="python-formalization-card"><h3>Antes: Python para BFS/DFS</h3><p>O problema podia ser descrito apenas como conexões entre estados. O algoritmo decidia a ordem pela estrutura da fronteira.</p><pre><code>estado_inicial = "Arad"
objetivo = "Bucharest"
...
# DFS: fronteira como pilha</code></pre></article>
            <article class="python-formalization-card"><h3>Agora: Python com heurística</h3><p>O problema passa a carregar custo real das ações e uma estimativa h(n), permitindo busca gulosa e A*.</p><pre><code>estado_inicial = "Arad"
objetivo = "Bucharest"
...
# A*: prioridade = g(n) + h(n)</code></pre></article>
          </div>
        </div>
      </section>`);
  };
